...
bool readTempMessage(char *payload, float *temperatureValue)
{
    ...
    //float to string
    char str[16];
    snprintf(str, sizeof(str), "%.2f", t);
    temperature = t;
    *temperatureValue = t;
    json_object_set_string(root_object, "SensorValue", str);
...
bool readHumMessage(char *payload, float *humidityValue)
{
    JSON_Value *root_value = json_value_init_object();
    JSON_Object *root_object = json_value_get_object(root_value);
    char *serialized_string = NULL;
